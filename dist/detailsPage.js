...
const detailContainer = document.getElementById("detail-container"); //allows TypeScript to know the element might not exist.
...
async function renderBorderCountries(borders = []) {
    ...
    const btnContainer = borderContainer.querySelector(".border-buttons");
